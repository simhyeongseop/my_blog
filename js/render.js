// Tailwind 스타일 변수 선언
const paginationStyle = "justify-center my-6";
const pageMoveButtonStyle = "px-4 py-2 rounded-lg text-emerald-800 hover:bg-emerald-100 transition font-semibold";
const pageNumberStyle = "mx-1 px-3 py-2 text-sm text-gray-600 bg-white rounded-lg hover:bg-emerald-100";
const pageNumberListStyle = "flex space-x-2";
const pageNumberActiveStyle = "font-bold underline text-emerald-600";
